...
var repositories = {
  sites: {
    basic: 'https://github.com/HansUXdev/foundation-static',
  ...
  apps: {
    ...
    marko: 'https://github.com/HansUXdev/marko-foundation',
  },
  emails: {
...
module.exports = function(args, options, callback, ee) {
  var projectName, projectFolder, framework, 
      sites_templates, app_templates, email_templates,
      WP_templates, messages, directory;
  ...
  function prompt(cb) {
    inquirer.prompt(util.questions(options), function(answers) {
      ...
      sites = answers.sites_templates || options.sites_templates || 'unspecified';
      apps = answers.app_templates || options.app_templates || 'unspecified';
      emails = answers.email_templates || options.email_templates || 'unspecified';
      wordpress = answers.WP_templates || options.WP_templates || 'unspecified';
  ...
  function gitClone(cb) {
    ...
    var repo = framework === 'sites'
      ? repositories.sites[sites]
      : repositories.apps[apps] || repositories.emails[emails] || repositories.wordpress[wordpress] || repositories[framework];
      /*
